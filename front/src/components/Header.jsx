    ...
    <div className="header-container">
      ...
      <div className="svg-images-container" style={{position: 'absolute',	left: '-9999px'}}>
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          ...
          <symbol id="svg-expand" viewBox="0 0 24 24" fill="none">
            <path d="M14 4H20V10" stroke="inherit" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M20 4L13 11" stroke="inherit" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10 20H4V14" stroke="inherit" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M4 20L11 13" stroke="inherit" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          </symbol>
          <symbol id="svg-zoom-in" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M10.5 8V13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
            <path d="M8 10.5H13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
          </symbol>
          <symbol id="svg-zoom-out" viewBox="0 0 24 24" fill="none">
            <circle cx="10.5" cy="10.5" r="5.75" stroke="currentColor" strokeWidth="1.8"/>
            <path d="M20 20L15.2 15.2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
            <path d="M8 10.5H13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
          </symbol>
